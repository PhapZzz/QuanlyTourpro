...
export default function SalesCustomers() {
  ...
  const openDetail = async (row) => {
    ...
    try {
      const r = await bookingAPI.getByCustomer(
        row.id,
        { size: 20 }
      )
      ...
      >
        ...
        <Space>
          ...
          <Select
            ...
            options={Object.entries(SEG_LABEL)
              .map(([k,v]) => ({
                value:k,
                label:v
              }))
        ...
        {detail && (
          ...
          <Tabs
            items={[

              {
                ...
                children:(
                  ...
                  >
                    ...
                    <Descriptions.Item label="Nguồn KH">
                      {SRC_LABEL[detail.source]}
                    </Descriptions.Item>

                    <Descriptions.Item label="Nhóm KH">
                      <Tag color={SEG_COLOR[detail.segment]}>
                        {SEG_LABEL[detail.segment]}
                      </Tag>
                    </Descriptions.Item>
              ...
              {
                key:'bookings',
                label:`Lịch sử đặt tour (${bookings.length})`,
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Select
                options={Object.entries(SRC_LABEL)
                  .map(([k,v]) => ({
                    value:k,
                    label:v
                  }))
